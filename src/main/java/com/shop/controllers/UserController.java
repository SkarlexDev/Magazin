...
public class UserController {
	...
	@PostMapping("/profile")
	public String editUser(@ModelAttribute User userData ,
			@AuthenticationPrincipal MyUserDetails userDetails, Model model,RedirectAttributes redirectAttributes) {
		String email = userDetails.getUsername();
		User user = userService.getUserEmail(email);
